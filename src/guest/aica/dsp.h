...
uint32_t aica_dsp_reg_read
	(struct aica *aica, uint32_t addr, uint32_t data_mask);

void aica_dsp_reg_write
	(struct aica *aica, uint32_t addr, uint32_t data, uint32_t data_mask);