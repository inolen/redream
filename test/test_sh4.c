...
struct sh4_test {
  ...
  int buffer_size;
  int buffer_offset;
  struct sh4_context in;
  struct sh4_context out;
};
...
static struct sh4_test_reg sh4_test_regs[] = {
    {"fpscr", offsetof(struct sh4_context, fpscr), 4},
    {"r0", offsetof(struct sh4_context, r[0]), 4},
    {"r1", offsetof(struct sh4_context, r[1]), 4},
    {"r2", offsetof(struct sh4_context, r[2]), 4},
    {"r3", offsetof(struct sh4_context, r[3]), 4},
    {"r4", offsetof(struct sh4_context, r[4]), 4},
    {"r5", offsetof(struct sh4_context, r[5]), 4},
    {"r6", offsetof(struct sh4_context, r[6]), 4},
    {"r7", offsetof(struct sh4_context, r[7]), 4},
    {"r8", offsetof(struct sh4_context, r[8]), 4},
    {"r9", offsetof(struct sh4_context, r[9]), 4},
    {"r10", offsetof(struct sh4_context, r[10]), 4},
    {"r11", offsetof(struct sh4_context, r[11]), 4},
    {"r12", offsetof(struct sh4_context, r[12]), 4},
    {"r13", offsetof(struct sh4_context, r[13]), 4},
    {"r14", offsetof(struct sh4_context, r[14]), 4},
    {"r15", offsetof(struct sh4_context, r[15]), 4},
    {"fr0", offsetof(struct sh4_context, fr[1]), 4},
    {"fr1", offsetof(struct sh4_context, fr[0]), 4},
    {"fr2", offsetof(struct sh4_context, fr[3]), 4},
    {"fr3", offsetof(struct sh4_context, fr[2]), 4},
    {"fr4", offsetof(struct sh4_context, fr[5]), 4},
    {"fr5", offsetof(struct sh4_context, fr[4]), 4},
    {"fr6", offsetof(struct sh4_context, fr[7]), 4},
    {"fr7", offsetof(struct sh4_context, fr[6]), 4},
    {"fr8", offsetof(struct sh4_context, fr[9]), 4},
    {"fr9", offsetof(struct sh4_context, fr[8]), 4},
    {"fr10", offsetof(struct sh4_context, fr[11]), 4},
    {"fr11", offsetof(struct sh4_context, fr[10]), 4},
    {"fr12", offsetof(struct sh4_context, fr[13]), 4},
    {"fr13", offsetof(struct sh4_context, fr[12]), 4},
    {"fr14", offsetof(struct sh4_context, fr[15]), 4},
    {"fr15", offsetof(struct sh4_context, fr[14]), 4},
    {"xf0", offsetof(struct sh4_context, xf[1]), 4},
    {"xf1", offsetof(struct sh4_context, xf[0]), 4},
    {"xf2", offsetof(struct sh4_context, xf[3]), 4},
    {"xf3", offsetof(struct sh4_context, xf[2]), 4},
    {"xf4", offsetof(struct sh4_context, xf[5]), 4},
    {"xf5", offsetof(struct sh4_context, xf[4]), 4},
    {"xf6", offsetof(struct sh4_context, xf[7]), 4},
    {"xf7", offsetof(struct sh4_context, xf[6]), 4},
    {"xf8", offsetof(struct sh4_context, xf[9]), 4},
    {"xf9", offsetof(struct sh4_context, xf[8]), 4},
    {"xf10", offsetof(struct sh4_context, xf[11]), 4},
    {"xf11", offsetof(struct sh4_context, xf[10]), 4},
    {"xf12", offsetof(struct sh4_context, xf[13]), 4},
    {"xf13", offsetof(struct sh4_context, xf[12]), 4},
    {"xf14", offsetof(struct sh4_context, xf[15]), 4},
    {"xf15", offsetof(struct sh4_context, xf[14]), 4},
};
