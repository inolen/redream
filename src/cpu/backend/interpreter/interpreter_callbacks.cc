...
REGISTER_CALLBACK(LOAD_LOCAL, LOAD_LOCAL, I8, I32, V);
REGISTER_CALLBACK(LOAD_LOCAL, LOAD_LOCAL, I16, I32, V);
REGISTER_CALLBACK(LOAD_LOCAL, LOAD_LOCAL, I32, I32, V);
REGISTER_CALLBACK(LOAD_LOCAL, LOAD_LOCAL, I64, I32, V);
REGISTER_CALLBACK(LOAD_LOCAL, LOAD_LOCAL, F32, I32, V);
REGISTER_CALLBACK(LOAD_LOCAL, LOAD_LOCAL, F64, I32, V);
...
REGISTER_CALLBACK(STORE_LOCAL, STORE_LOCAL, V, I32, I8);
REGISTER_CALLBACK(STORE_LOCAL, STORE_LOCAL, V, I32, I16);
REGISTER_CALLBACK(STORE_LOCAL, STORE_LOCAL, V, I32, I32);
REGISTER_CALLBACK(STORE_LOCAL, STORE_LOCAL, V, I32, I64);
REGISTER_CALLBACK(STORE_LOCAL, STORE_LOCAL, V, I32, F32);
REGISTER_CALLBACK(STORE_LOCAL, STORE_LOCAL, V, I32, F64);
